...
export default function CourseRegistrationManager() {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel('public:course_registrations')
            ...
            <div className="flex-1 w-full">
              <div className="flex flex-wrap items-start justify-between gap-4 mb-3">
                <div>
                  ...
                  <p className="text-brand-purple font-semibold text-sm">{reg.course_name}</p>
                </div>
